var R=Object.defineProperty;var H=(t,e,s)=>e in t?R(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var E=(t,e,s)=>(H(t,typeof e!="symbol"?e+"":e,s),s);import{s as c}from"./applyAssets-da72c5cd.js";import{i as v}from"./vendor-f93ed741.js";function O(){document.querySelector(".filter-list-js").classList.add("hidden-form");const e=document.querySelector(".wrap-js"),s=document.createElement("p");s.className="favorite-text",e.appendChild(s),s.textContent="It appears that you haven`t added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future."}const h=(t,e)=>t.length<=e?t:`${t.slice(0,e)}...`;function N(t){const e=document.querySelector(".filter-list-js");e.classList.remove("hidden-form"),t.length>6?e.classList.add("scroll"):e.classList.remove("scroll");const s=t.map(({_id:o,target:i,name:r,bodyPart:a,burnedCalories:n,time:L})=>`
...
//# sourceMappingURL=exercises-right-part-filter-9658b708.js.map
