var M=Object.defineProperty;var R=(t,e,s)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var $=(t,e,s)=>(R(t,typeof e!="symbol"?e+"":e,s),s);import{s as c}from"./applyAssets-83809cc8.js";import{i as v}from"./vendor-f93ed741.js";function H(){document.querySelector(".filter-list-js").classList.add("hidden-form");const e=document.querySelector(".wrap-js"),s=document.createElement("p");s.className="favorite-text",e.appendChild(s),s.textContent="It appears that you haven`t added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future."}const h=(t,e)=>t.length<=e?t:`${t.slice(0,e)}...`;function O(t){const e=document.querySelector(".filter-list-js");e.classList.remove("hidden-form"),t.length>6?e.classList.add("scroll"):e.classList.remove("scroll");const s=t.map(({_id:o,target:i,name:r,bodyPart:a,burnedCalories:n,time:E})=>`
