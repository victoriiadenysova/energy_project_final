var M=Object.defineProperty;var R=(t,e,s)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var $=(t,e,s)=>(R(t,typeof e!="symbol"?e+"":e,s),s);import{i as v}from"./vendor-f93ed741.js";function H(){document.querySelector(".filter-list-js").classList.add("hidden-form");const e=document.querySelector(".wrap-js"),s=document.createElement("p");s.className="favorite-text",e.appendChild(s),s.textContent="It appears that you haven`t added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future."}const c="/energy_project_final/assets/sprite-c2a9f1af.svg",h=(t,e)=>t.length<=e?t:`${t.slice(0,e)}...`;function O(t){const e=document.querySelector(".filter-list-js");e.classList.remove("hidden-form"),t.length>6?e.classList.add("scroll"):e.classList.remove("scroll");const s=t.map(({_id:o,target:i,name:r,bodyPart:a,burnedCalories:n,time:E})=>`
  <li class="favourites_list_item" id=${o}>
    ...
    </span>`;return r+"</div>"}function Y(t){return t?`<button class="add-favorite-js" type="button" style="font-size: 14px;">
      ...
      <div class="get-rating-choise">
        ...
        <form class="form raiting-form">
          ...
          <button class="raiting-form-submit" type="submit">Send</button>
                                    ...
                                    </button>`,e.dataset.favorite="false",T(s),i==="favorites.html"&&y()}function nt(t){var i,r,a;const e=t.target;if(e.classList.contains("favourites_btn_trash_icon")){const n=e.dataset.id||((r=(i=e.closest("[data-id]"))==null?void 0:i.dataset)==null?void 0:r.id);if(!n)return;T(n),y();return}const s=e.closest("[data-id]"),o=(a=s==null?void 0:s.dataset)==null?void 0:a.id;o&&(e.classList.contains("favourites_btn_workout")||rt(o))}et.addEventListener("click",nt);const rt=async t=>{if(!t)return;let e;try{d.open(),e=await w.getOneExercises(t)}catch(o){_.error((o==null?void 0:o.message)||String(o));return}finally{d.close()}if(!e){_.error("Exercise not found or request failed");return}let s=!1;try{const o=localStorage.getItem("favorites"),i=o?JSON.parse(o):[];s=Array.isArray(i)&&i.some(r=>(r==null?void 0:r._id)===t)}catch{s=!1}e.favorite=s,b.open(Z(e)),S=document.querySelector(".refresh-button-js"),L=document.querySelector(".add-rating"),L&&L.addEventListener("click",ot),S&&S.addEventListener("click",it)};export{h as a,G as c,w as f,d as l,_ as m,c as s};
//# sourceMappingURL=exercises-right-part-filter-b16be917.js.map
