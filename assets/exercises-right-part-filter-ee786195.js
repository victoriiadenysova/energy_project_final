var R=Object.defineProperty;var H=(t,e,s)=>e in t?R(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var E=(t,e,s)=>(H(t,typeof e!="symbol"?e+"":e,s),s);import{s as c}from"./applyAssets-483e6db6.js";import{i as v}from"./vendor-f93ed741.js";function O(){document.querySelector(".filter-list-js").classList.add("hidden-form");const e=document.querySelector(".wrap-js"),s=document.createElement("p");s.className="favorite-text",e.appendChild(s),s.textContent="It appears that you haven`t added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future."}const h=(t,e)=>t.length<=e?t:`${t.slice(0,e)}...`;function A(t){const e=document.querySelector(".filter-list-js");e.classList.remove("hidden-form"),t.length>6?e.classList.add("scroll"):e.classList.remove("scroll");const s=t.map(({_id:o,target:i,name:r,bodyPart:a,burnedCalories:n,time:L})=>`
  ...
  </button>`}function Y(t){const e=M(t==null?void 0:t.rating,0),s=Number.isFinite(e)?e.toFixed(1):"—";return`<div class="modal-info" data-id="${u(t==null?void 0:t._id,"")}">
      ...
      <div class="get-rating-choise">
        ...
        <form class="form raiting-form">
          ...
          <button class="raiting-form-submit" type="submit">Send</button>
                                    ...
                                    </button>`,e.dataset.favorite="false",T(s),i==="favorites.html"&&y()}function it(t){var i,r,a;const e=t.target;if(e.classList.contains("favourites_btn_trash_icon")){const n=e.dataset.id||((r=(i=e.closest("[data-id]"))==null?void 0:i.dataset)==null?void 0:r.id);if(!n)return;T(n),y();return}const s=e.closest("[data-id]"),o=(a=s==null?void 0:s.dataset)==null?void 0:a.id;o&&(e.classList.contains("favourites_btn_workout")||nt(o))}tt.addEventListener("click",it);const nt=async t=>{if(!t)return;let e;try{d.open(),e=await w.getOneExercises(t)}catch(o){_.error((o==null?void 0:o.message)||String(o));return}finally{d.close()}if(!e){_.error("Exercise not found or request failed");return}let s=!1;try{const o=localStorage.getItem("favorites"),i=o?JSON.parse(o):[];s=Array.isArray(i)&&i.some(r=>(r==null?void 0:r._id)===t)}catch{s=!1}e.favorite=s,b.open(Y(e)),$=document.querySelector(".refresh-button-js"),S=document.querySelector(".add-rating"),S&&S.addEventListener("click",st),$&&$.addEventListener("click",ot)};export{h as a,Q as c,w as f,d as l,_ as m};
//# sourceMappingURL=exercises-right-part-filter-ee786195.js.map
